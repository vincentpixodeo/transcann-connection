...
$action = $instance->getAction(\WMS\Apis\IntegrationWebServices\Receptions::class);
...
if ($action->execute($data)) {
	...
	$logger = new \WMS\Helpers\Logs\LogFile($instance->storagePath('logs/IntegrationWebServices/Receptions'));
